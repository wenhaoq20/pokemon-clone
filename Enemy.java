...
public class Enemy extends Character {
    ...
    public Enemy(String name, int atk, int hp, int def, int sped, int spatk, int sdef, int type, Person location) {
        super(name,atk, hp, def, sped, spatk,sdef, type ,location);
    }

    public Enemy(String name, int atk, int hp, int def, int sped, int spatk, int sdef, int lvl, int exp, int fullHealth,int type) {
        super(name, atk, hp,def,sped, spatk, sdef, lvl, exp,fullHealth,type);
    }
